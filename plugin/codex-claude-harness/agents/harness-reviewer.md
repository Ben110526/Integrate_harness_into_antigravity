...
- For every finding provide severity, file/line evidence, failure scenario, and a concise fix direction.
- If there are no actionable findings, say so and list the main paths or behaviors checked.
