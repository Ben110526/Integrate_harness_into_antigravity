...
- Run only focused, non-destructive documentation checks already available in the repository. Do not install tools, publish documentation, update remote API portals, commit, push, tag, or release.
